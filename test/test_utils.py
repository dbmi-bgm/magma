...
def test_inputgen_WGS_trio_scatter():
    ...
    result = [
        ...
        'parameters': {},
        'input_files': [
            {'argument_name': 'fastq_R1', 'uuid': 'A1', 'mount': True},
            {'argument_name': 'fastq_R2', 'uuid': 'A2', 'mount': True},
            {'argument_name': 'reference', 'uuid': 'b24ed5ed-a037-48a0-a938-3fecfb90d0cf', 'mount': True}]},
        ...
        'parameters': {},
        'input_files': [
            {'argument_name': 'fastq_R1', 'uuid': 'C1', 'mount': True},
            {'argument_name': 'fastq_R2', 'uuid': 'C2', 'mount': True},
            {'argument_name': 'reference', 'uuid': 'b24ed5ed-a037-48a0-a938-3fecfb90d0cf', 'mount': True}]},
        ...
        'parameters': {},
        'input_files': [
            {'argument_name': 'fastq_R1', 'uuid': 'D1', 'mount': True},
            {'argument_name': 'fastq_R2', 'uuid': 'D2', 'mount': True},
            {'argument_name': 'reference', 'uuid': 'b24ed5ed-a037-48a0-a938-3fecfb90d0cf', 'mount': True}]},
        ...
        'parameters': {},
        'input_files': [
            {'argument_name': 'input_bams', 'uuid': ['uuid-bam_w_readgroups-2:0', 'uuid-bam_w_readgroups-2:1', 'uuid-bam_w_readgroups-2:2'], 'mount': True}]}
        ]
    shard = [
