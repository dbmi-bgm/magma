...
def input_generator(wfl_obj, run_obj, input_format='zebra'):
    '''

            wfl_obj, Wfl object representing a meta-workflow
            run_obj, WflRun object representing a meta-workflow-run
    '''
    for shard_obj in run_obj.to_run():
        # Get metadata and prepare input json
